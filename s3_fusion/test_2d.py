...
class TestDataLoader():
    ...
    def make_dataset(self, img_path, height=256, width=256, stride=256):
        ...
        samples = np.zeros((n_row * n_col, height, width, self.config.DATASET.NUM_BAND), dtype=np.uint8)
...
def parse_args():
    ...
    parser.add_argument('--weights_path', help='the path of test model', default='/emwuser/znr/code/hyper_sar/outputs/20220606_2d_hrnet_epoch200_lr1e-2_MS/hyper_sar/2dhrnet_w18_train_256_1e-2_MS')
    parser.add_argument('--weights_name', help='the name of test model weight', default='hrnet_2d_epoch197_tr_fwiou_0.91568_tr_OA_0.9533_val_fwiou_0.69099_val_OA_0.8074.pth')
    parser.add_argument('--save_path', help='the path of save file', default='/emwuser/znr/data/hyper_sar/test/pre/20220606_2d_hrnet_epoch200_lr1e-2_MS')
...
def main_worker(gpu, args):
    ...
    for i in range(len(names)):
        f_name = f_names[i]
        print(f_name)
        test_dataset = TestDataLoader(f_name, config)
