...
class SegmentationDatasetLoader_2d():
    def __init__(self,
                 image_path,
                 label_path,
                 num_classes=9, multi_scale=False, flip=True,
...
if __name__ == '__main__':
    ...
    aaa = SegmentationDatasetLoader_2d(image_path, label_path, label_mapping = LABEL_MAPPING)
