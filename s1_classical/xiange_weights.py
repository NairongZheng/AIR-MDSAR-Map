...
def Deeplabv3(input_shape=(None, None, 3), classes=8, OS=16, activation='softmax', drop_pro=0.5, middle_repeat=16, PSP=True):
    ...
    if PSP:
        x = Concatenate()([x_PSP, b4, b0, b1, b2, b3])
    else:
